...
[![Build Check](https://github.com/litongle/GoGoGo/actions/workflows/build-check.yml/badge.svg)](https://github.com/litongle/GoGoGo/actions/workflows/build-check.yml)
[![CodeQL](https://github.com/litongle/GoGoGo/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/litongle/GoGoGo/actions/workflows/codeql-analysis.yml)
</div>
...
## 简介
&emsp;&emsp;影梭是一个基于 Android 调试 API + 高德地图及定位 SDK 实现的安卓定位修改工具，并且同时实现了一个可以自由控制移动的摇杆。使用影梭，不需要 ROOT 权限就可以随意修改自己的当前位置以及模拟移动。

1. 源码仓库：[Github](https://github.com/litongle/GoGoGo)
2. 下载地址：[Github Releases](https://github.com/litongle/GoGoGo/releases)
...
1. 该 APP 仅仅是为了学习 Android + 地图定位相关实现方法，请勿用于游戏作弊！
2. 该 APP 仅仅是为了学习 Android + 地图定位相关实现方法，请勿用于游戏作弊！
3. 该 APP 仅仅是为了学习 Android + 地图定位相关实现方法，请勿用于游戏作弊！
...
MAPS_API_KEY=你的高德 Android Key
```

## 文档
&emsp;&emsp;如果有疑问可以直接搜索 ISSUE 或者在仓库中提交问题。
